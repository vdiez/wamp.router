...
module.exports = {
    ...
    CALLEE_FAILURE: 'wamp.error.callee_failure',
    GOODBYE_OUT: 'wamp.error.goodbye_and_out',
    ...
    CALL_CANCELLED: 'wamp.error.canceled',
    OPTION_NOT_ALLOWED: 'wamp.error.option_not_allowed',
    DISCLOSE_DISALLOWEDL: 'wamp.error.option_disallowed.disclose_me',
    NETWORK_FAILURE: 'wamp.error.network_failure',
    UNAVAILABLE: 'wamp.error.unavailable',
    CALLEE_UNAVAILABLE: 'wamp.error.no_available_callee',
